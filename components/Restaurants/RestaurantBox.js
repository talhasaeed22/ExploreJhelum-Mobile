...
const RestaurantBox = ({ navigation, path, name, location, element }) => {
  return (
    <>
      ...
      <View style={{display:'flex', alignItems:"flex-end", paddingHorizontal:30, paddingVertical:10}}>
        <TouchableOpacity style={{marginVertical:10}} onPress={() => { navigation.navigate('RestaurantDetail', {element:element}) }}>
